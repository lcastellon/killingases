    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          El enlace no existe o la mesa ya se cerró.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mata Ases — Poker Omaha con amigos" },
      {
        name: "description",
        content: "Mesas privadas de Omaha No Limit para jugar poker con tus amigos en tiempo real.",
      },
      { property: "og:title", content: "Mata Ases — Poker Omaha con amigos" },
      {
        property: "og:description",
        content: "Crea una mesa, comparte el código y juega Omaha No Limit en tiempo real.",
      },
