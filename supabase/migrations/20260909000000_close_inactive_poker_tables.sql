-- Mantiene poker_tables.updated_at como la última actividad real de juego.
-- Los latidos de presencia (last_seen_at) no cuentan: una pestaña olvidada no
-- debe mantener una mesa abierta para siempre.
...
-- Cierra mesas inactivas y devuelve las fichas al banco. Si había una mano
-- abandonada, también devuelve las fichas comprometidas en su bote.
...
SELECT cron.schedule(
  'close-inactive-poker-tables',
  '* * * * *',
  'SELECT public.close_inactive_poker_tables(10);'
);
